...
# # P0 Het and Ko analysis Replicate 2
# AT Updated 8/8/24
...
adata_het = sc.read_10x_mtx('/Users/atrevisa/Desktop/KO_sc/ForceCells/P0HetR2_filtered_feature_bc_matrix',
...
adata_ko = sc.read_10x_mtx('/Users/atrevisa/Desktop/KO_sc/ForceCells/P0KoR2_filtered_feature_bc_matrix',
                            var_names='gene_symbols',cache=True)
adata_ko.var_names_make_unique()
adata_ko


# Merge the data (no batch correction or anything like that)
...
adata_filtered = adata_filtered[~adata_filtered.obs.leiden.isin(["0", "7", "13", "9", "14", "12", "10", "8", "6"])]
...
# Second round
adata_filtered = adata_filtered[~adata_filtered.obs.leiden.isin(["15", "2"])]
...
# ## Select for V1's and perform analysis again from scratch -2
...
cluster(adata_V1, neighbors = 50, pcs = 12, res = 0.72)
